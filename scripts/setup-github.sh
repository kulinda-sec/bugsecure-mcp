...
# Private vulnerability reporting and secret scanning are public-repository
# features (the API answers 404 / 422 on a private one without Code Security).
...
JSON
  ...
  warn "repository is not public yet: private vulnerability reporting and secret scanning left as is (re-run after going public)"
fi
